...
{
    Task CreateNotificationAsync(string userId, string title, string message, NotificationType type, string? link = null, object? extraData = null);
...
{
    Task<Feedback> CreateFeedbackAsync(string userId, string message, int rating, string? subject = null, string? category = null);
...
public interface IDashboardService
{
    ...
    Task MarkCommissionPaidAsync(int id);
    Task RecalculateCommissionsAsync();
}
