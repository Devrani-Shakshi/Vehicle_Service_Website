        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_AspNetUsers_ServiceProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ShopkeeperId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Products", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Products_AspNetUsers_ShopkeeperId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_AspNetUsers_ServiceProviderId",
                        column: x => x.ServiceProviderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 3, 28, 20, 25, 16, 627, DateTimeKind.Utc).AddTicks(9041), "Plumbing and pipe repair services", "fas fa-wrench", true, "Plumbing" },
                    { 2, new DateTime(2026, 3, 28, 20, 25, 16, 627, DateTimeKind.Utc).AddTicks(9916), "Electrical repair and installation", "fas fa-bolt", true, "Electrical" },
                    { 3, new DateTime(2026, 3, 28, 20, 25, 16, 627, DateTimeKind.Utc).AddTicks(9917), "Woodwork and furniture repair", "fas fa-hammer", true, "Carpentry" },
                    { 4, new DateTime(2026, 3, 28, 20, 25, 16, 627, DateTimeKind.Utc).AddTicks(9918), "Home and office cleaning services", "fas fa-broom", true, "Cleaning" },
                    { 5, new DateTime(2026, 3, 28, 20, 25, 16, 627, DateTimeKind.Utc).AddTicks(9919), "Interior and exterior painting", "fas fa-paint-roller", true, "Painting" },
                    { 6, new DateTime(2026, 3, 28, 20, 25, 16, 627, DateTimeKind.Utc).AddTicks(9920), "Heating, ventilation and air conditioning", "fas fa-fan", true, "HVAC" },
                    { 7, new DateTime(2026, 3, 28, 20, 25, 16, 627, DateTimeKind.Utc).AddTicks(9921), "Home appliance repair services", "fas fa-tools", true, "Appliance Repair" },
                    { 8, new DateTime(2026, 3, 28, 20, 25, 16, 627, DateTimeKind.Utc).AddTicks(9922), "Pest control and fumigation", "fas fa-bug", true, "Pest Control" }
                });
