...
{
    /// <inheritdoc />
    public partial class CreateFreshSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VehicleModels_AspNetUsers_ServiceProviderId",
                        column: x => x.ServiceProviderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BatteryStateOfHealth = table.Column<int>(type: "int", nullable: true),
                    KilometersDriven = table.Column<long>(type: "bigint", nullable: true),
                    VehicleModelName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServiceRequests_VehicleModels_VehicleModelId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 9, 6, 35, 30, 140, DateTimeKind.Utc).AddTicks(9479), "EV battery diagnostics, repair and replacement", "fas fa-car-battery", true, "Battery Service" },
                    { 2, new DateTime(2026, 4, 9, 6, 35, 30, 141, DateTimeKind.Utc).AddTicks(696), "Electric motor diagnostics and repair", "fas fa-cogs", true, "Motor Repair" },
                    { 3, new DateTime(2026, 4, 9, 6, 35, 30, 141, DateTimeKind.Utc).AddTicks(698), "Charging port, cable and system repair", "fas fa-charging-station", true, "Charging System" },
                    { 4, new DateTime(2026, 4, 9, 6, 35, 30, 141, DateTimeKind.Utc).AddTicks(700), "Tyre replacement, alignment and balancing", "fas fa-tire", true, "Tyre & Wheel" },
                    { 5, new DateTime(2026, 4, 9, 6, 35, 30, 141, DateTimeKind.Utc).AddTicks(701), "Brake pad, disc and regenerative braking repair", "fas fa-brake", true, "Brake System" },
                    { 6, new DateTime(2026, 4, 9, 6, 35, 30, 141, DateTimeKind.Utc).AddTicks(702), "Electronic control unit and controller repair", "fas fa-microchip", true, "Controller / ECU" },
                    { 7, new DateTime(2026, 4, 9, 6, 35, 30, 141, DateTimeKind.Utc).AddTicks(703), "Body repair, dent removal and painting", "fas fa-spray-can", true, "Body & Paint" },
                    { 8, new DateTime(2026, 4, 9, 6, 35, 30, 141, DateTimeKind.Utc).AddTicks(704), "Routine EV maintenance and general servicing", "fas fa-tools", true, "General Servicing" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceRequests_VehicleModelId",
                table: "ServiceRequests",
                column: "VehicleModelId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleModels_ModelNumber",
                table: "VehicleModels",
                column: "ModelNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_VehicleModels_ServiceProviderId",
                table: "VehicleModels",
                column: "ServiceProviderId");
        }
